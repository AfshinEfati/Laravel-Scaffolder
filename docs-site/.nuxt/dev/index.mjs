...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, removeResponseHeader, getQuery as getQuery$1, readBody, getCookie, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file:///app/docs-site/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///app/docs-site/node_modules/@vue/shared/dist/shared.cjs.js';
import _RemarkEmoji from 'file:///app/docs-site/node_modules/remark-emoji/index.js';
import { visit } from 'file:///app/docs-site/node_modules/unist-util-visit/index.js';
import { toString } from 'file:///app/docs-site/node_modules/hast-util-to-string/index.js';
import { createStorage, defineDriver, prefixStorage } from 'file:///app/docs-site/node_modules/unstorage/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, isRelative } from 'file:///app/docs-site/node_modules/ufo/dist/index.mjs';
import { hash as hash$2 } from 'file:///app/docs-site/node_modules/ohash/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///app/docs-site/node_modules/defu/dist/defu.mjs';
import { dirname as dirname$1, resolve as resolve$1, extname } from 'file:///app/docs-site/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///app/docs-site/node_modules/scule/dist/index.mjs';
import { unified } from 'file:///app/docs-site/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///app/docs-site/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///app/docs-site/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///app/docs-site/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///app/docs-site/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///app/docs-site/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///app/docs-site/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///app/docs-site/node_modules/micromark-util-sanitize-uri/dev/index.js';
import remarkParse from 'file:///app/docs-site/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///app/docs-site/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///app/docs-site/node_modules/remark-mdc/dist/index.mjs';
import remarkGFM from 'file:///app/docs-site/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///app/docs-site/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///app/docs-site/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///app/docs-site/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///app/docs-site/node_modules/rehype-raw/index.js';
import { detab } from 'file:///app/docs-site/node_modules/detab/index.js';
import Slugger from 'file:///app/docs-site/node_modules/github-slugger/index.js';
import destr, { destr as destr$1 } from 'file:///app/docs-site/node_modules/destr/dist/index.mjs';
import { createWasmOnigEngine } from 'file:///app/docs-site/node_modules/shiki/dist/engine-oniguruma.mjs';
import viteNodeEntry_mjs from 'file:///app/docs-site/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///app/docs-site/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import slugify from 'file:///app/docs-site/node_modules/slugify/slugify.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///app/docs-site/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///app/docs-site/node_modules/vue/server-renderer/index.mjs';
import { createHooks } from 'file:///app/docs-site/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///app/docs-site/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///app/docs-site/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///app/docs-site/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///app/docs-site/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///app/docs-site/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///app/docs-site/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///app/docs-site/node_modules/klona/dist/index.mjs';
import { getContext } from 'file:///app/docs-site/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///app/docs-site/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///app/docs-site/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///app/docs-site/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///app/docs-site/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///app/docs-site/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///app/docs-site/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///app/docs-site/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///app/docs-site/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///app/docs-site/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { hash as hash$1 } from 'file:///app/docs-site/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///app/docs-site/node_modules/@nuxt/nitro-server/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///app/docs-site/node_modules/nuxt/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///app/docs-site/node_modules/@nuxt/nitro-server/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/app/docs-site/server/assets"}];
...
const _47app_47docs_45site_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/app/docs-site","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/app/docs-site/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('cache:nuxt:payload', _47app_47docs_45site_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/app/docs-site/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/app/docs-site/.nuxt/cache/nuxt/payload"}));
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/app/docs-site/content"}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/app/docs-site/.nuxt/content-cache"}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/app/docs-site/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/app/docs-site/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/app/docs-site/.data/kv"}));
...
const _Tpbnykrbs2gLkm4D6LAHt5D4HptGQeJG5Rrr3X04yOc = (function(nitro) {
...
const _3gilonob5iP2PwuMC6xYoOcs1GWr5EiEk6mx0DOFxXw = defineNitroPlugin(async (nitro) => {
...
const _Aqh0HhY6ovlJvgwqIhJTSR_obCySmq1p7dTWZCALBjM = (nitroApp) => {
...
const _1Pjxcm7zJPIH1r4ubo3plq8IzSQAcAiZN7QlHshii8c = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _Tpbnykrbs2gLkm4D6LAHt5D4HptGQeJG5Rrr3X04yOc,
_3gilonob5iP2PwuMC6xYoOcs1GWr5EiEk6mx0DOFxXw,
_Aqh0HhY6ovlJvgwqIhJTSR_obCySmq1p7dTWZCALBjM,
_1Pjxcm7zJPIH1r4ubo3plq8IzSQAcAiZN7QlHshii8c,
...
const _TsqtA0 = eventHandler((event) => {
...
const _7NFbSa = eventHandler(async (event) => {
...
const _y_lZHP = defineEventHandler(async (event) => {
...
const _aZHVpo = defineEventHandler(async (event) => {
...
const _4IZVx7 = defineEventHandler(async (event) => {
  const { getContentQuery } = await Promise.resolve().then(function () { return query; });
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _lazy_OR9xAR = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _TsqtA0, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_OR9xAR, lazy: true, middleware: false, method: undefined },
  { route: '/api/_mdc/highlight', handler: _7NFbSa, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _y_lZHP, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _y_lZHP, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _y_lZHP, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _aZHVpo, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _4IZVx7, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _4IZVx7, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _4IZVx7, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_OR9xAR, lazy: true, middleware: false, method: undefined }
];
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///app/docs-site/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
function createShikiHighlighter({
  ...
  async function _getShiki() {
    const { createHighlighterCore, addClassToHast, isSpecialLang, isSpecialTheme } = await import('file:///app/docs-site/node_modules/shiki/dist/core.mjs');
    const { transformerNotationDiff, transformerNotationErrorLevel, transformerNotationFocus, transformerNotationHighlight } = await import('file:///app/docs-site/node_modules/@shikijs/transformers/dist/index.mjs');
...
const bundledLangs = {
"javascript": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/javascript.mjs'),
"js": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/javascript.mjs'),
"jsx": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/jsx.mjs'),
"json": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/json.mjs'),
"typescript": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/typescript.mjs'),
"ts": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/typescript.mjs'),
"tsx": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/tsx.mjs'),
"vue": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/vue.mjs'),
"css": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/css.mjs'),
"html": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/html.mjs'),
"shellscript": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/shellscript.mjs'),
"bash": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/shellscript.mjs'),
"sh": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/shellscript.mjs'),
"shell": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/shellscript.mjs'),
"zsh": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/shellscript.mjs'),
"markdown": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/markdown.mjs'),
"md": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/markdown.mjs'),
"mdc": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/mdc.mjs'),
"yaml": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/yaml.mjs'),
"yml": () => import('file:///app/docs-site/node_modules/shiki/dist/langs/yaml.mjs'),
};
const bundledThemes = {
"github-dark": () => import('file:///app/docs-site/node_modules/shiki/dist/themes/github-dark.mjs').then(r => r.default),
};
const options = {};
const engine = createWasmOnigEngine(() => import('file:///app/docs-site/node_modules/shiki/dist/wasm.mjs'));
