...
import { withAsyncContext, ref, computed, mergeProps, unref, withCtx, createVNode, toDisplayString, useSSRContext, createTextVNode } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderSlot } from "vue/server-renderer";
import { u as useAsyncData, q as queryContent, _ as __nuxt_component_2 } from "./query-RT5V1MJ1.js";
import { a as useRoute, c as useState, u as useHead } from "../server.mjs";
  ...
  async setup(__props) {
    ...
    const results = computed(() => {
      ...
      return searchResults.value.filter(
        (item) => item.title.toLowerCase().includes(q.value.toLowerCase()) || item.description?.toLowerCase().includes(q.value.toLowerCase())
      ).slice(0, 10);
    });
...
//# sourceMappingURL=default-zzyr9w-w.js.map
