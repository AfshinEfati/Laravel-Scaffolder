import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import _RemarkEmoji from 'file:///app/docs-site/node_modules/remark-emoji/index.js';
