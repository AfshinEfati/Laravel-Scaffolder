import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, toRef, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, withCtx, getCurrentScope, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'file:///app/docs-site/node_modules/vue/index.mjs';
import { $fetch } from 'file:///app/docs-site/node_modules/ofetch/dist/node.mjs';
import { h as baseURL } from '../nitro/nitro.mjs';
import { createHooks } from 'file:///app/docs-site/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///app/docs-site/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///app/docs-site/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///app/docs-site/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///app/docs-site/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///app/docs-site/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///app/docs-site/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///app/docs-site/node_modules/nuxt/node_modules/unhead/dist/utils.mjs';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./_...slug_-mxViu1qb.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DTAPhitW.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-CUraHxds.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-DVkjYk-k.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-C2tgz5RD.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-zE7hn5dv.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-DIHkEoZ6.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BIoXWyHK.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-akGOTClX.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-Bgv2wVdU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-JkyMeHy2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-B_iTJcbz.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-6nVSfOx5.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BGV3c3QT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-CjjxnTAb.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-zzyr9w-w.mjs').then((m) => m.default || m))
};
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    computed(() => route.path.startsWith("/fa"));
    if (route.path === "/") {
      navigateTo("/en");
    }
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B9QomExg.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BW4A7SwR.mjs'));
...
export { useRoute as a, useRuntimeConfig as b, useState as c, useRouter as d, entry_default as default, encodeRoutePath as e, useNuxtApp as f, nuxtLinkDefaults as g, asyncDataDefaults as h, createError as i, useRequestEvent as j, navigateTo as n, resolveRouteObject as r, useHead as u };
