import { computed, toValue, getCurrentInstance, onServerPrefetch, defineComponent, shallowRef, provide, cloneVNode, h, createElementBlock, ref, nextTick, unref, toRef } from 'file:///app/docs-site/node_modules/vue/index.mjs';
import { debounce } from 'file:///app/docs-site/node_modules/perfect-debounce/dist/index.mjs';
import { f as useNuxtApp, h as asyncDataDefaults, b as useRuntimeConfig, i as createError, j as useRequestEvent } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file:///app/docs-site/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///app/docs-site/node_modules/ohash/dist/index.mjs';
import { u as useContentPreview } from './preview-CxS_JB1H.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CpazKEU0.mjs').then((m) => m.useContentDatabase());
...
export { __nuxt_component_2 as _, useContentDisabled as a, addPrerenderPath as b, createQuery as c, ensureArray as d, encodeQueryParams as e, sortList as f, get as g, apply as h, withoutKeys as i, jsonStringify as j, withKeys as k, assertArray as l, omit as o, queryContent as q, shouldUseClientDB as s, useAsyncData as u, withContentBase as w };
//# sourceMappingURL=query-RT5V1MJ1.mjs.map
